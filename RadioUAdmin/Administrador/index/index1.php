...
<html>
	...
	<body>
		...
		<div id="cuadro">
			...
			<form action="../actions/insertar.php" method="POST" enctype="multipart/form-data">
				<table class="table">
					<tr>
					...
					<tr class="bg-info">
						...
						<td>
							<form  action="../actions/programa.php" method="POST">
						...
						echo "<tr>
								 ...
								 <td>".$fecha2. "</td>
							 	 <td>
									 ...
									 <br>
									 <form action='../ventanaModificar/modificar.php?id=".$row['id']."'method='POST' enctype='multipart/form-data'>
